...
NOTE: workspace_access and workspace_members modules have been removed as part
of the workspace cleanup. These tests are skipped.
"""
import unittest

raise unittest.SkipTest("workspace_access and workspace_members modules removed")
