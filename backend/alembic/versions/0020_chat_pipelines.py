...
def upgrade():
    ...
    op.create_index('idx_pipelines_v2_user', 'pipelines_v2', ['user_id'])
    op.create_index('idx_pipelines_v2_workspace', 'pipelines_v2', ['workspace_id'])
    op.create_index('idx_pipelines_v2_status', 'pipelines_v2', ['status'])
    ...
    op.create_index('idx_pipeline_runs_v2_pipeline', 'pipeline_runs_v2', ['pipeline_id'])
    op.create_index('idx_pipeline_runs_v2_session', 'pipeline_runs_v2', ['session_id'])
    op.create_index('idx_pipeline_runs_v2_status', 'pipeline_runs_v2', ['status'])
    ...
    op.create_index('idx_transformation_steps_session', 'transformation_steps', ['chat_session_id'])
    op.create_index('idx_transformation_steps_run', 'transformation_steps', ['pipeline_run_id'])
    ...
    op.create_index('idx_chat_templates_workspace', 'chat_templates', ['workspace_id'])
    ...
    op.create_index('idx_chat_session_snapshots_session', 'chat_session_snapshots', ['session_id'])
