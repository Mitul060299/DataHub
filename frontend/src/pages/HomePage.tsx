    ...
    <main className="app-page home-page" ref={mainRef}>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          >
            ...
            <button type="button" className="hero-demo-btn" onClick={handleGetStarted}>↑</button>
          </motion.div>
      ...
      <section id="pricing" className="hp-section">
        <div className="hp-inner">
          ...
          {/* Enterprise row: Business · Enterprise */}
              ...
              {reviewSuccess ? (
                ...
                <form className="feedback-form" onSubmit={(e) => void handleReviewSubmit(e)}>
                  ...
                  <div className="review-star-picker">
                    ...
                    {[1, 2, 3, 4, 5].map((s) => (
                      <button key={s} type="button" className={`review-star-btn${s <= reviewRating ? " review-star-active" : ""}`} onClick={() => setReviewRating(s)} aria-label={`${s} star`}>★</button>
                    ))}
                  </div>
            ...
            <div>
              {successName ? (
                ...
                <form className="feedback-form" onSubmit={(event) => void handleFeedbackSubmit(event)}>
                  ...
                  <input className="feedback-input" placeholder="Subject — e.g. 'Feature request: Notion connector'" value={subject} onChange={(event) => setSubject(event.target.value)} />
                  <textarea className="feedback-textarea" placeholder="Tell us what's on your mind — the more detail the better..." value={message} onChange={(event) => setMessage(event.target.value)} />
      ...
      <footer className="hp-footer">
        <div className="footer-inner">
          ...
          <div className="footer-bottom">
            <span>© {new Date().getFullYear()} DataHub. All rights reserved.</span>
          </div>
        </div>
      </footer>
      ...
      {waitlistModal && (
        ...
        >
          ...
          >
            {waitlistDone ? (
              <>
                <p style={{ margin: 0, fontSize: 22, fontWeight: 700, color: "#e8e8f0" }}>You&apos;re on the waitlist! 🎉</p>
